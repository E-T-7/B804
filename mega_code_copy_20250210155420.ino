...
{   
   ...
   if (PS5ControllerLive) {
      ...
      int RXjoystickValue = reqRightJoyXValue;  // This value could be negative, zero, or positive
      int servoAngle1 = map(RXjoystickValue, -100, 100, 0, 175);
      servoAngle1 = constrain(servoAngle1, 0, 175);
...
// SAMPLE CUSTOM DROID FUNCTION from PS5 REQUEST - REMOVE ONCE YOU UNDERSTAND STRUCTURE
